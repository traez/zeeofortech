...
const projectsArray: Array<DataType> = [
  {
    ...
    relevance:
      "Responsive movie discovery app built using the TMDB API. Enables users to explore and view detailed movie info. Solves the problem of quickly finding and learning about movies. App showcases my skills in API integration, UI design, and creating an intuitive user experience.",
  ...
  },
  {
    ...
    relevance:
      "Developed a responsive Tic-Tac-Toe game allowing players to compete against each other or an AI opponent. Implemented smart AI for a challenging experience and state persistence for seamless gameplay across sessions, enhancing engagement and usability across devices.",
  ...
  },
  {
    ...
    relevance:
      "The Quiz App offers an engaging way for users to test their knowledge on various topics and difficulty levels, enhancing learning through interactivity. It provides randomized questions, tracks scores, and improves user engagement with an intuitive interface.", // Adjust relevance as needed
  ...
  },
  {
    ...
    relevance:
      "The Rock, Paper, Scissors App provides a fun and responsive gaming experience against a computer opponent. It adapts to all screen sizes, retains scores across sessions, and offers various gameplay options, ensuring an engaging and entertaining experience for users.", // Adjust relevance as needed
  ...
  },
  {
    ...
    website:
      "https://bettami-figma-conversion-xuaib-trae-zeeofors-projects.vercel.app",
    relevance:
      "This project showcases my ability to transform Figma UI designs into responsive HTML and CSS, demonstrating pixel-perfect accuracy and adherence to design standards. It highlights my skills in accessibility and cross-browser compatibility, inviting users to hire me for similar coding projects.", // Adjust relevance as needed
  ...
  },
  {
    ...
    relevance:
      "This Multiplication Mastery Game helps users improve their math skills by offering dynamic table ranges and close-range multiple choices for increased difficulty. It tracks wrong answers for review, promoting focused learning and mastery of multiplication tables.", // Adjust relevance as needed
  ...
  },
  {
    ...
    relevance:
      "The Random Reasons Generator App offers persuasive arguments for supporting Peter Obi and humorous counterpoints for opponents. Each click presents new reasons, unique visuals, and dynamic UI changes, making it a fun, interactive way to explore political perspectives.",
  ...
  },
  {
    ...
    relevance:
      "The Calisthenics Exercise Gallery helps users find and learn fitness exercises grouped by purpose (upper body, lower body, core). With search, bookmarking, and instructional videos, it offers a comprehensive resource for improving fitness through targeted exercise routines.", // Adjust relevance as needed
  ...
  },
  {
    ...
    relevance:
      "This motivational quotes platform empowers users to share, manage, and engage with quotes through voting and commenting. By fostering community interaction and personalization with theme toggling, it enhances user experience and promotes a culture of inspiration and support.", // Adjust relevance as needed
  ...
  },
  {
    ...
    relevance:
      "This ride-booking dashboard simplifies travel planning, enabling users to book, edit, or cancel rides with real-time vehicle details and pricing. Featuring dynamic forms, responsive design, and API integrations, it delivers a seamless, user-friendly experience for managing trips.",
  ...
  },
  {
    ...
    relevance:
      "This app provides a user-friendly interface for account management, with responsive login, dashboard, user list, and detail pages. It offers smooth navigation, efficient data handling, and high-quality design, optimized for desktop and mobile devices",
  ...
  },
  {
    ...
    relevance:
      "The app enables users to explore and filter profiles of Nigerians abroad based on attributes like age, gender, and location, utilizing PostgreSQL and Supabase for dynamic data fetching and efficient filtering with an intuitive interface.",
    screenshot: "/ss-naija-japa-postgresql-app.png",
  },
  {
    name: "frontend-intern-task-moonex-dotprolabs",
    category: "Figma-to-Code Projects",
    sourceCode: "https://github.com/traez/frontend-intern-task-moonex-dotprolabs",
    website: "https://frontend-intern-task-moonex-dotprolabs.vercel.app",
    relevance:
      "The project challenges developers to create a responsive, interactive website using React, Tailwind CSS, and ShadCN, emphasizing adaptability, animations, and polished design, deployed live on Vercel or Netlify with public GitHub source code.",
    screenshot: "/ss-frontend-intern-task-moonex-dotprolabs.png",
  },
];
